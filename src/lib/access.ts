 ...
 *
 * A copy of `SIGNUP_ACCESS_KEY` from MyStokio's `src/lib/legal.ts`. Duplicated rather
 ...
 * so a MyCodeScan signup creates an account that also signs in to MyStokio. Leaving this
